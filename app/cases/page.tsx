  ...
  return (
    <>
      <div className="page-head">
        <div>
          <div className="eyebrow">Case Prep</div>
          <h1>Set up a case</h1>
      ...
      <div className="page-head" style={{ marginTop: "var(--s6)" }}>
        <div>
          <h2>Your library</h2>
      ...
      {loadingLib ? (
        ...
        <div className="empty">
          ...
          Generate one above and it lands here, re-attemptable and comparable over time.
        </div>
      ) : (
        <div className="stack">
          {library.map((c) => (
            <div className="card interactive row wrap" key={c.id} onClick={() => attempt(c)}>
